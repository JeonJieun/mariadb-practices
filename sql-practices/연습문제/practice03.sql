...
select a.emp_no as '사번', concat(a.first_name, ' ', a.last_name) as '이름', b.salary as 연봉, e.title as '직책', d.dept_name as '부서'
...
select a.emp_no as '사번', concat(a.first_name, ' ', a.last_name) as '이름',  c.title as '직책', b.salary as '급여'
from employees a, salaries b, titles c
where a.emp_no = b.emp_no
and a.emp_no = c.emp_no
and c.to_date = '9999-01-01'
...
select c.dept_name as '부서', avg(a.salary) as '평균 연봉'
...
select b.title as '직책', avg(a.salary) as '평균 연봉'
